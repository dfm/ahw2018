...
\url{https://github.com/dfm/imprs/blob/master/mcmc/data.txt}.
...
\begin{eqnarray}
\ln p(m,\,b,\,\ln s) &\propto& -\frac{3}{2}\ln(1+b^2) \quad.
\end{eqnarray}
...
Make all the diagnostic plots from above but include one other plot: the
